    ...
    "routes": [
      ...
      },
      {
        ...
        "routes": [
          ...
          {
            "component": () => React.createElement(require('/Users/vinne/Github/umi-examples/with-dva/node_modules/umi-build-dev/lib/plugins/404/NotFound.js').default, { pagesPath: 'src/pages', hasRoutesInConfig: false })
          }
        ]
      },
      {
